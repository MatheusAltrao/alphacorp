          ...
          <div className="flex flex-col gap-4 md:gap-6 lg:flex-row">
            <Card className="bg-secondary rounded-xl border-none p-6 shadow-none">
              <CardContent className="flex flex-col gap-2 p-0 md:gap-3">
                <h3 className="text-primary font-semibold">Meetings analyzed</h3>
                <span className="text-foreground text-3xl font-semibold md:text-4xl">5M+</span>
            ...
            <Card className="bg-secondary rounded-xl border-none p-6 shadow-none">
              <CardContent className="flex flex-col gap-2 p-0 md:gap-3">
                ...
                <span className="text-foreground text-3xl font-semibold md:text-4xl">500K+</span>
                <p className="text-muted-foreground text-base">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit interdum hendrerit ex vitae sodales.
                </p>
              </CardContent>
            ...
            <Card className="bg-secondary rounded-xl border-none p-6 shadow-none">
              <CardContent className="flex flex-col gap-2 p-0 md:gap-3">
                ...
                <span className="text-foreground text-3xl font-semibold md:text-4xl">4.85/5</span>
                <p className="text-muted-foreground text-base">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit interdum hendrerit ex vitae sodales.
                </p>
              </CardContent>
